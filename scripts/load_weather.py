...
def load_to_supabase():
    ...
    for i in range(0, len(df), batch_size):
        ...
        insert_sql = f"INSERT INTO weather_data(time, temperature_C, humidity_percent, wind_speed_kmph, city, extracted_at) VALUES {','.join(values)};"


        # REMOTE PROCEDURE CALL = run sql code inside the database
